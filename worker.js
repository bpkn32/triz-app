...
function buildSolutionPrompt(problem, contradictions, candidatePrinciples, selectionPolicy) {
  ...
  userPrompt += `---\n\nConstraint: Use only the candidate TRIZ inventive principles provided above. Do not introduce, reference, or apply any TRIZ inventive principle outside this candidate set.\n\nRequirement: Every supplied contradiction must be adequately addressed.\n\n---\n\nSolution Field Requirements:\nWrite the "solution" value as a neutral, humanized engineering write-up of the proposed solution — as if it were the Solution or Implementation section of a technical report written by the engineer who solved the problem. It must NOT mention TRIZ, inventive principles (by name or number), contradictions, parameters, matrices, or any analytical framework — describe only the concrete engineering solution and its rationale, in plain domain language, as if the ideas originated from ordinary engineering reasoning rather than a structured method. Do not use headings, bullet points, numbered lists, or markdown formatting — write one continuous flowing paragraph or a few connected paragraphs of prose. Do not use AI-assistant phrasing (e.g., "As an AI", "Based on the given principles", "I selected principle X"). Target roughly 150-300 words.\n\n---\n\nRespond only as JSON:\n{"selectedPrinciples":[{"id":<number>,"name":"<string>"}],"contradictionCoverage":[{"contradictionId":"C1","addressedByPrincipleIds":[<number>],"explanation":"..."}],"principleApplication":[{"principleId":<number>,"application":"..."}],"solution":"..."}`;
